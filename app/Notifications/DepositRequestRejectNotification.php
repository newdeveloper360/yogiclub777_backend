...
class DepositRequestRejectNotification extends Notification
{
    use Queueable;
    protected $amount;
    protected $fcm;
    ...
    public function toFcm()
    {
         ...
         try {
            $message = "Your Recharge of ₹' . $this->amount . ' has been Rejected";
        ...
        //                 'notification' => [
        //                     'body' => 'Your Recharge of ₹' . $this->amount . ' has been Rejected',
