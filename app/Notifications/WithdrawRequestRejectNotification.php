...
class WithdrawRequestRejectNotification extends Notification
{
    use Queueable;
    ...
    public function toFcm()
    {
        ...
        try {
            $message = "Your withdrawal of ₹' . $this->amount . ' has been Rejected";
        ...
        //                 'notification' => [
        //                     'body' => 'Your withdrawal of ₹' . $this->amount . ' has been Rejected',
