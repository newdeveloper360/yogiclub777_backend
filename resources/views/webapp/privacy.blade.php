...
<body>
    ...
    <p>
        {{ env('APP_NAME') }} built the {{ env('APP_NAME') }} app as
        a Free app. This SERVICE is provided by
        {{ env('APP_NAME') }} at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        {{ env('APP_NAME') }} unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
        For a better experience, while using our Service, I
        may require you to provide us with certain personally
        identifiable information, including but not limited to Name, Mobile. The information that
    ...
    <p>This policy is effective as of 2023-06-13</p>
    <p><strong>Contact Us</strong></p>
    <p>
        If you have any questions or suggestions about my
        Privacy Policy, do not hesitate to contact me at charnsinghmeena7553@gmail.com.
    </p>
