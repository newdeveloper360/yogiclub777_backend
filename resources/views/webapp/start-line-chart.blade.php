                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tb">{{ $result->monday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->tuesday_open_pana }}</span>
                                <span class="tb">{{ $result->tuesday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->wednesday_open_pana }}</span>
                                <span class="tb">{{ $result->wednesday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->thursday_open_pana }}</span>
                                <span class="tb">{{ $result->thursday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->friday_open_pana }}</span>
                                <span class="tb">{{ $result->friday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->saturday_open_pana }}</span>
                                <span class="tb">{{ $result->saturday_open_digit }}</span>
                            </td>
                            <td>
                                <span class="tn">{{ $result->sunday_open_pana }}</span>
                                <span class="tb">{{ $result->sunday_open_digit }}</span>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
